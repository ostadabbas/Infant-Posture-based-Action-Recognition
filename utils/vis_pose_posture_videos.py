...
def show_posture_img(img, img_name, output_path, posture_p, score_p):
    ...
    str1 = posture_label[idx_list[4]] + ':%.4f'% score_p[idx_list[4]]
    str2 = posture_label[idx_list[3]] + ':%.4f'% score_p[idx_list[3]]
    str3 = posture_label[idx_list[2]] + ':%.4f'% score_p[idx_list[2]]
    str4 = posture_label[idx_list[1]] + ':%.4f'% score_p[idx_list[1]]
    str5 = posture_label[idx_list[0]] + ':%.4f'% score_p[idx_list[0]]
    ...
    if posture_anno == True:
        ...
        c = 'k'
    '''
    plt.gca().add_patch(Rectangle((0, h-(5*40+10)), 280, 210,  alpha = 0.4, facecolor='w', edgecolor='none'))
...
if __name__ == '__main__':
    pred_2d_postures_root = '/work/aclab/xiaof.huang/fu.n/InfantAction/posture_2d_res'
    pred_3d_postures_root = '/work/aclab/xiaof.huang/fu.n/InfantAction/posture_3d_res'
    imgs_root = '/work/aclab/xiaof.huang/fu.n/InfantAction/pose_2d_vis'
    output_root = '/work/aclab/xiaof.huang/fu.n/InfantAction/posture_2d_vis'
