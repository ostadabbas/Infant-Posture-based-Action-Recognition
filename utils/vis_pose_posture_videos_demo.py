...
def show_posture_img(img, img_name, output_path, posture_p, score_p):
    ...
    if num >= 2102 and num <= 2544:
        fst = 'Standing'
        sec = 'Sitting'
    elif num >= 2545 and num <= 2608:
        fst = 'Prone'
        sec = 'All Fours'
    elif num >= 2609 and num <= 3878:
        fst = 'Standing'
        sec = 'Supine'
    elif num >= 3879 and num <= 3929:
        fst = 'Sitting'
        sec = 'All Fours'
    elif num >= 3930 and num <= 3997:
        fst = 'Prone'
        sec = 'All Fours'
    elif num >= 3998 and num <= 4136:
        fst = 'Standing'
        sec = 'Supine'
    elif num >= 4137 and num <= 4433:
        fst = 'Standing'
        sec = 'All Fours'

    elif num >= 4434 and num <= 4513:
        fst = 'Prone'
        sec = 'All Fours'

    elif num >= 4514 and num <= 4602:
        fst = 'Sitting'
        sec = 'All Fours'
...
if __name__ == '__main__':
    pred_2d_postures_fd = '/work/aclab/xiaof.huang/fu.n/InfantAction/videos9_demo_outputs/posture_2d_res/4'
    imgs_root = '/work/aclab/xiaof.huang/fu.n/InfantAction/videos9_demo_outputs/pose_2d_vis/4'
    output_root = '/work/aclab/xiaof.huang/fu.n/InfantAction/videos9_demo_outputs/demo/4'
